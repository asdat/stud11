...
<title>Компьютерная периферия, Гавриленко</title>
    	...
    	<div id="top_nav" class="ddsmoothmenu">
            ...
            $menu=[
                ...
                ['title'=>'Категории', 'link'=>'#categories',
                    'children'=>[
                       ['title'=>'Наушники', 'link'=>'#наушники',
                           'children'=>[
                               ['title'=>'Гарнитуры', 'link'=>'#гарнитуры'],
                               ['title'=>'Наушники для ПК', 'link'=>'#нпк']
                                                          ]
                           ],
                       ['title'=>'Аудио', 'link'=>'#аудио',
                           'children'=>[
                               ['title'=>'Акустические системы','link'=>'#akussistem'],
                               ['title'=>'Портативные плееры','link'=>'#miniplayer'],
                               ['title'=>'Усилители','link'=>'#usil'], 
                               ['title'=>'Музыкальные центры, магнитолы','link'=>'#boombox']
                           ]
                           ],
                       ['title'=>'Мониторы', 'link'=>'#мониторы'],
                       ['title'=>'Флешки, HDD', 'link'=>'#флешки'],
                       ['title'=>'Принтеры', 'link'=>'#принтеры'],
                       ['title'=>'Мыши', 'link'=>'#мыши'],
                       ['title'=>'Клавиатуры', 'link'=>'#клавиатуры'],
                       ['title'=>'Джойстики', 'link'=>'#джойстики']
                    ]],
                ['title'=>'FAQs', 'link'=>'#faq'],
   ...
   /*         echo "<ul class=\"menu\">\n";
       ...
       <!--    <ul>
                ...
                <li><a href="products.html">Products</a>
                    <ul>
                        <li><a href="#submenu1">Sub menu 1</a>
        	...
        	<div class="sidebar_box"><span class="bottom"></span>
                ...
                <div class="content"> 
                	<ul class="sidebar_list">
                    	<li class="first"><a href="#">Наушники</a></li>
                        <li><a href="#">Акустичиские системы, колонки</a></li>
...
<div class="product_box">
    ...
    <div id="templatemo_footer">
    	...
    	PHP 16-01 <a href="#">GAVRILENKO</a> <!-- Credit: www.templatemo.com --></div> <!-- END of templatemo_footer -->
